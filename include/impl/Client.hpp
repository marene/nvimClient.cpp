...
namespace nvimRpc {
	...
	class Client {
		...
		public:
			...
			std::vector<std::string> buffer_get_line_slice(msgpack::type::ext buffer, int64_t start, int64_t end, bool include_start, bool include_end) {
				std::vector<std::string> ret;
				auto packedResponse = _call<std::vector<std::string>>("buffer_get_line_slice", buffer, start, end, include_start, include_end);

				_handleResponse(packedResponse, ret);
				return ret;
			}

			std::vector<std::string> nvim_buf_get_lines(msgpack::type::ext buffer, int64_t start, int64_t end, bool strict_indexing) {
				std::vector<std::string> ret;
				auto packedResponse = _call<std::vector<std::string>>("nvim_buf_get_lines", buffer, start, end, strict_indexing);

				_handleResponse(packedResponse, ret);
				return ret;
			}

			void buffer_set_line_slice(msgpack::type::ext buffer, int64_t start, int64_t end, bool include_start, bool include_end, std::vector<std::string> replacement) {
				auto packedResponse = _call<packer::Void>("buffer_set_line_slice", buffer, start, end, include_start, include_end, replacement);

				_handleResponse(packedResponse);
			}

			void nvim_buf_set_lines(msgpack::type::ext buffer, int64_t start, int64_t end, bool strict_indexing, std::vector<std::string> replacement) {
				auto packedResponse = _call<packer::Void>("nvim_buf_set_lines", buffer, start, end, strict_indexing, replacement);
			...
			void nvim_buf_set_keymap(msgpack::type::ext buffer, std::string mode, std::string lhs, std::string rhs, nvimRpc::types::Dictionary opts) {
			...
			std::vector<int64_t> nvim_buf_get_extmark_by_id(msgpack::type::ext buffer, int64_t ns_id, int64_t id, nvimRpc::types::Dictionary opts) {
				std::vector<int64_t> ret;
			...
			nvimRpc::types::Array nvim_buf_get_extmarks(msgpack::type::ext buffer, int64_t ns_id, msgpack::type::ext start, msgpack::type::ext end, nvimRpc::types::Dictionary opts) {
			...
			int64_t nvim_buf_set_extmark(msgpack::type::ext buffer, int64_t ns_id, int64_t line, int64_t col, nvimRpc::types::Dictionary opts) {
				int64_t ret;
			...
			int64_t nvim_buf_add_highlight(msgpack::type::ext buffer, int64_t src_id, std::string hl_group, int64_t line, int64_t col_start, int64_t col_end) {
				int64_t ret;
				auto packedResponse = _call<int64_t>("nvim_buf_add_highlight", buffer, src_id, hl_group, line, col_start, col_end);
			...
			int64_t nvim_buf_set_virtual_text(msgpack::type::ext buffer, int64_t src_id, int64_t line, nvimRpc::types::Array chunks, nvimRpc::types::Dictionary opts) {
				int64_t ret;
			...
			void nvim_input_mouse(std::string button, std::string action, std::string modifier, int64_t grid, int64_t row, int64_t col) {
			...
			void nvim_set_client_info(std::string name, nvimRpc::types::Dictionary version, std::string type, nvimRpc::types::Dictionary methods, nvimRpc::types::Dictionary attributes) {
			...
			std::vector<std::string> buffer_get_lines(msgpack::type::ext buffer, int64_t start, int64_t end, bool strict_indexing) {
				std::vector<std::string> ret;
			...
			void buffer_set_lines(msgpack::type::ext buffer, int64_t start, int64_t end, bool strict_indexing, std::vector<std::string> replacement) {
			...
			int64_t buffer_add_highlight(msgpack::type::ext buffer, int64_t src_id, std::string hl_group, int64_t line, int64_t col_start, int64_t col_end) {
				int64_t ret;
				auto packedResponse = _call<int64_t>("buffer_add_highlight", buffer, src_id, hl_group, line, col_start, col_end);
